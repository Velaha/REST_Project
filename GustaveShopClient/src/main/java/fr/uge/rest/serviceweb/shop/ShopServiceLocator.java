...
public class ShopServiceLocator extends org.apache.axis.client.Service implements fr.uge.rest.serviceweb.shop.ShopService {
    ...
    private java.lang.String Shop_address = "http://localhost:8081/GustaveShopServer/services/Shop";
    ...
    public fr.uge.rest.serviceweb.shop.Shop getShop(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fr.uge.rest.serviceweb.shop.ShopSoapBindingStub _stub = new fr.uge.rest.serviceweb.shop.ShopSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (fr.uge.rest.serviceweb.shop.Shop.class.isAssignableFrom(serviceEndpointInterface)) {
                fr.uge.rest.serviceweb.shop.ShopSoapBindingStub _stub = new fr.uge.rest.serviceweb.shop.ShopSoapBindingStub(new java.net.URL(Shop_address), this);
                _stub.setPortName(getShopWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://shop.serviceweb.rest.uge.fr", "ShopService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://shop.serviceweb.rest.uge.fr", "Shop"));
        }

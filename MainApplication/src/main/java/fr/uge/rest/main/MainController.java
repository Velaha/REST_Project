...
import main.java.fr.uge.rest.bike.IBikeService;
import main.java.fr.uge.rest.user.IUser;
import main.java.fr.uge.rest.user.IUserService;
...
public class MainController {
	...
	public String postAdminAddBikeFormAdd(@ModelAttribute("etat") String etat, BindingResult bindingResult, Model model)
	...
	public String postUserFormConnect(@ModelAttribute("name") String name, BindingResult bindingResult, Model model)
			throws RemoteException {
	...
	public String postUserAddBikeFormAdd(@ModelAttribute("etat") String etat, BindingResult bindingResult, Model model)
			throws RemoteException {
	...
	public String postUserRentBikeChoose(@RequestParam(value = "choose") int id, Model model) throws RemoteException {
		...
		if (!bike.getAvailable())  {
			bikeService.putInWaitingLine((long) id, (fr.uge.rest.user.IUser) this.currentUser);
	...
	public String postUserReturnBikeValidate(@ModelAttribute("etat") String etat,
			@ModelAttribute("comment") String comment, @ModelAttribute("note") String note, BindingResult bindingResult,
